...
#read_file = pd.read_csv (r'/home/delluser/Desktop/throughput1.txt')
#read_file.to_csv (r'/home/delluser/Desktop/throughput1.csv', index=None)
...
df_hex_hsw1 = pd.read_csv("/home/ithemal/ithemal/hsw_uica.csv", usecols = ['hex'], low_memory = False)
hex_list_hsw1 = df_hex_hsw1.values.tolist()
...
#with open("/home/delluser/Documents/ithemal/Ithemal/data_collection/build/bin/output_hsw_1.csv", 'r') as file3:
...
for i in range (len(hex_list_hsw1)):
	contents1.append(hex_list_hsw1[i])
...
print(lista)
torch.save(lista, "tensor_hsw_bdw.data")
